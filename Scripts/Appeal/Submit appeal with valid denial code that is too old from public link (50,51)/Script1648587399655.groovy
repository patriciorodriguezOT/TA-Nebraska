...
String errorText = String.format("An error was encountered. The denial code of %s was not found in the system or is older than 50 days.", GlobalVariable.G_Appeal_Code);
